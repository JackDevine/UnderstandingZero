...
function accuracy(tstate, data)
	ŷ = onecold(Lux.apply(tstate.model, data[1], tstate.parameters, tstate.states)[1],
		        [-1 0 1])
	mean(ŷ .== onecold(data[2], [-1, 0, 1]))
end
...
git-tree-sha1 = "df839386a7abdc82ae0799be793ea9e038eb6da0"
...
git-tree-sha1 = "b104b0be198614ef7da2b41e0fbc91c22f744255"
